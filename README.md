...
![CI](https://github.com/a-2-c-2-anpm/at-autem-vel/workflows/CI/badge.svg)
...
```javascript
import { roles } from '@a-2-c-2-anpm/at-autem-vel';
```
...
```javascript
import { elementRoles } from '@a-2-c-2-anpm/at-autem-vel';
```
...
```javascript
import { roleElements } from '@a-2-c-2-anpm/at-autem-vel';
```
